...
function decodeHtmlEntities(text) {
  return text.replace(/&quot;/g, '"').replace(/&amp;/g, "&").replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&#x27;/g, "'").replace(/&#x2F;/g, "/").replace(/&#96;/g, "`").replace(/&#x60;/g, "`").replace(/&nbsp;/g, " ");
}
...
var LINK_EXTRACT_PROMPT = `\u4F60\u662F\u4E00\u4E2A\u4FE1\u606F\u6574\u7406\u52A9\u624B\u3002\u6839\u636E\u63D0\u4F9B\u7684\u7F51\u9875\u5185\u5BB9\uFF0C\u63D0\u53D6\uFF1A
1. \u4E00\u6BB5\u7B80\u6D01\u7684\u4E2D\u6587\u6458\u8981\uFF0850\u5B57\u4EE5\u5185\uFF09
...
// .wrangler/tmp/bundle-F6IziM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-F6IziM/middleware-loader.entry.ts
